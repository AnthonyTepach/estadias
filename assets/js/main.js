$(function(){
    ...
    var base_url='http://cetic.estadiasyestancias.org/index.php'; // Here i define the base_url
            ...
            modal({
                ...
                buttons: {
                    add: {
                        ...
                        label: 'Guardar' // Buttons label
                    }
                },
                title: 'Guardar evento (' + date.format() + ')' // Modal title
            });
        },
