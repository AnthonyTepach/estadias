                    ...
                    <div class="modal-body">
                        ...
                        <form class="form-horizontal" id="crud-form">
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="title">Titúlo</label>
                                <div class="col-md-4">
                                    <input id="title" name="titulo" type="text" class="form-control input-md" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <span class="help-block">Selecciona un color</span>
                                </div>
                            </div>
                        </form>
                    </div>
